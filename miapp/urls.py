...
urlpatterns = [
    ...
    path('ejemplar/nuevo_prestamo',PrestamoCreate.as_view(),name='Nuevo_Prestamo'),
    path('ejemplar/listar_prestamo',PrestamoList.as_view(),name='Listar_Prestamo'),
    path('ejemplar/eliminar/prestamo/<int:pk>',PrestamoDelete.as_view(),name='Eliminar_Prestamo'),
    path('ejemplar/editar/prestamo/<int:pk>',PrestamoUpdate.as_view(),name='Editar_Prestamo'),
    path('IniciarSesion/',LoginView.as_view(template_name='accounts/login.html'),name='login'),
    path('LogoutSesion/',PrestamoUpdate.as_view(template_name='accounts/logout.html'),name='logout'),
